    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-lg">
                ...
                <h2 className="text-xl font-semibold text-center text-gray-700 mb-6">Welcome Back</h2>
                ...
                <p className="text-center text-gray-500 text-sm mt-6">
                    Don't have an account? <Link to="/signup" className="font-bold text-brand-primary hover:text-brand-accent">Sign up</Link>
                </p>
            </div>
        </div>
    );
